...
# print(Path(".").absolute())
# print(Path("./data/data/set1-ja_jp.json").exists())
...
class Card:
	def __init__(self, card=None, **kwargs):
		...
		self.image_online = f"https://raw.githubusercontent.com/pedrofracassi/lor-bundles/master/set{self.card_set}/ja_jp/img/cards/{self.cardCode}.png"
	...
	@property
	def region(self):
		return self._card_data["regionRefs"][0].lower()
